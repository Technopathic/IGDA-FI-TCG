<script>
  ...
  export let supertype = "volunteers";
  export let rarity = "common";

  // image props
  export let img = "";
  export let back = "/prototype/igda-finland/volunteers/igda-finland-card-1-back.png";
  export let foil = "";
  export let mask = "";
  ...
  const activate = (e) => {
    if ($activeCard && $activeCard === thisCard) {
      ...
      gtag("event", "select_item", {
        ...
        item_list_name: "IGDA Finland Cards",
        items: [
          {
            item_id: id,
            item_name: name,
  ...
  <div 
    ...
    <button
      ...
      <img
        class="card__back"
        src={back_img}
        alt="The back of an IGDA Finland card, the IGDA Finland logo in the center"
        loading="lazy"
        width="660"
        height="921"
      />
      <div class="card__front" 
        ...
        <img
          src={front_img}
          alt="Front design of the {name} IGDA Finland card, with the stats and info around the edge"
          on:load={imageLoader}
          loading="lazy"
          width="660"
          height="921"
